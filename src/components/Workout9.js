        ...
        <DayBlock>
            ...
            <WorkoutBlock>
                ...
                <div>
                    ...
                    <div className="div1">
                        <p className="p2">3 sets x 4 reps @ 85%</p>
                        <input type="checkbox"/>
                    </div>
                    <div className="div1">
                        <p className="p2">1 sets x 5 reps @ 90%</p>
                        <input type="checkbox"/>
                    </div>
                </div>
            </WorkoutBlock>
            ...
            <WorkoutBlock>
                ...
                <div>
                    <div className="div1">
                        <p className="p2">1 sets x 3 reps @ 60%</p>
                        <div>
                            <input type="checkbox"/>
                        </div>
                    </div>
                    <div className="div1">
                        <p className="p2">1 sets x 3 reps @ 70%</p>
                        <input type="checkbox"/>
                    </div>
                    <div className="div1">
                    ...
                    <div className="div1">
                        <p className="p2">2 sets x 5 reps @ 85%</p>
                        <input type="checkbox"/>
                    </div>
                </div>
            </WorkoutBlock>
            ...
            <WorkoutBlock>
                ...
                <div>
                    <div className="div1">
                        <p className="p2">1 sets x 4 reps @ 65%</p>
                        <div>
                            <input type="checkbox"/>
                        </div>
                    </div>
                    ...
                    <div className="div1">
                        <p className="p2">5 sets x 4 reps @ 80%</p>
                        <input type="checkbox"/>
                    </div>
                </div>
            </WorkoutBlock>
